...
function LocationWeatherCache()
{
    ...
    this.addLocation = function(latitude, longitude, nickname)
    {
        ...
        latitude:lattitude,
        longitude:longitude,
        //Need to access forecast.io API to fill the forecast object
        forecast:{}
    ...
    this.toJSON = function() {
         ...
         var locationToJSON = JSON.stringify(newLocation)
    ...
    this.initialiseFromPDO = function(locationWeatherCachePDO) {
         ...
         for(i=0;i<=locations.length;i++){
             locations.push(JSONlocations[i]);
         }
...
{
    localStorage.setItem(APP_PREFIX, locationToJSON)
}
var locationsCacheInstance = new LocationWeatherCache()
